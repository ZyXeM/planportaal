...
/**
 * CodValue Class Doc Comment
 *
 * @category Class
 * @description The amount that a consignee has to pay on receipt of a \&quot;Cash On Delivery\&quot; order.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CodValue implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CodValue';
     ...
     * Sets value
     *
     * @param double|null $value The value of the amount that has to be paid.  Example: `value:40.2`
     *
     * @return $this
     */
