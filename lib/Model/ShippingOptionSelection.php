...
/**
 * ShippingOptionSelection Class Doc Comment
 *
 * @category Class
 * @description Contains details of the shipping option that your customer selected at checkout.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ShippingOptionSelection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingOptionSelection';
     ...
     * Sets identifier
     *
     * @param string $identifier A shipping option's Paazl code. You will find a list of the identifiers of the shipping options available to your webshop in your webshop account under *Settings>Account>Overview of shipping options*.  Example: `identifier:\"AVG\"`
     *
     * @return $this
     */
