...
/**
 * ShopOrderSenderAddress Class Doc Comment
 *
 * @category Class
 * @description Contains details of the address of the party that shipped an order.  **Note!** If not provided, the default is the address specified in your web app account under *Settings&gt;Account&gt;My address book&gt;Sender address*.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ShopOrderSenderAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopOrderSenderAddress';
     ...
     * Sets city
     *
     * @param string|null $city The city in which the party that shipped an order is located.  **Note!** If you provide a sender address, `city` is required.  Example: `city:\"Bonn\"`
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string|null $country The ISO 3166-2 code for the country in which the party that shipped an order is located.  The default value is \"NL\".  Example: `country:\"DE\"`
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code of the address of the party that shipped an order.  Example: `postalCode:\"53111\"`
     *
     * @return $this
     */
     ...
     * Sets province
     *
     * @param string|null $province The province or state in which the party that shipped an order is located.  Example: `province:\"Nordrhein-Westfalen\"`
     *
     * @return $this
     */
     ...
     * Sets street
     *
     * @param string|null $street The street name of the address of the party that shipped an order.  See the note in the general method description.  Example: `street:\"John Plagis Avenue\"`
     *
     * @return $this
     */
     ...
     * Sets street_lines
     *
     * @param string[]|null $street_lines The street address of the party that shipped an order, specified as a series of strings.  See the note in the general method description.  **Note!** Paazl does not parse the string to perform validation with any values that may be provided for the other parameters of a sender address.  Example: `streetLines:\"6 John Plagis Avenue\", \"Around the corner\"`
     *
     * @return $this
     */
     ...
     * Sets house_number
     *
     * @param int|null $house_number The house number of the address of the party that shipped an order.  See the note in general method description.  Example: `houseNumber:6`
     *
     * @return $this
     */
     ...
     *
     * @param string|null $house_number_extension The house number extension (such as the \"-A\" in \"12-A\") of the address of the party that shipped an order.  Example: `houseNumberExtension:\"-A\"`
     *
     * @return $this
     */
