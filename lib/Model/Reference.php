...
class Reference implements ModelInterface, ArrayAccess
{
     ...
     * Sets reference
     *
     * @param string $reference Your reference for the checkout session whose details you want to retrieve.  **Note!** If the reference value you provide already exists, Paazl will replace the existing session with a new session.  Example: `reference:\"order1234\"`
     *
     * @return $this
     */
