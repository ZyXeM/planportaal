 ...
 *
 * @category Class
 * @description Contains a carrier&#39;s details.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Carrier implements ModelInterface, ArrayAccess
{
     ...
     * Sets description
     *
     * @param string|null $description The name of a carrier, as configured by [Paazl Customer Support](mailto:support@paazl.com).
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The Paazl identifier for a carrier. This should correspond with one of the identifiers you see in your web app account under *Settings>Account>Overview of shipping options*.
     *
     * @return $this
     */
