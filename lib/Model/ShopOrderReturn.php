...
/**
 * ShopOrderReturn Class Doc Comment
 *
 * @category Class
 * @description Contains details of the party to return an order to.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ShopOrderReturn implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopOrderReturn';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'address' => '\OpenAPI\Client\Model\ShopOrderReturnAddress'
    ];
     ...
     * Sets name
     *
     * @param string|null $name The name of the party to return an order to.  Example: `name:\"A'dam Mac Tosch\"`
     *
     * @return $this
     */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\ShopOrderReturnAddress
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\ShopOrderReturnAddress $address address
     *
     * @return $this
     */
